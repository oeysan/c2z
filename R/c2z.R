...
#' @keywords internal
#' @noRd
Dict <- \(x = NULL, lang = "nn", data = NULL, error = NULL) {
  ...
  if (is.null(data)) {
    # Get the path to the CSV file within your package
    csv.file <- system.file("extdata", "i18n.csv", package = "c2z")

    # Read the CSV file into a data frame
    data <- readr::read_csv(csv.file, col_types = readr::cols())
  }
