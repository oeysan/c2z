...
github.version <- sprintf(
  "https://img.shields.io/badge/GitHub-%s-red.svg?style=flat-square",
...
id="logo" title="Logo">
<img src="man/figures/badge.webp" width="250px" alt="Logo" />
</a></p>

<p align="center">
<a href="https://oeysan.github.io/c2z/news/index.html" id="news" title="News">
<img src="`r reviewed.date`" alt="News"/> </a><br/><a href="#" id="cran" 
title="CRAN Version">
...
<img src="`r github.version`" alt="GitHub Version" />
...
(e.g., [mailR](https://github.com/rpremrajGit/mailR)). If you really feel like
it you could use 
[Home Assistant](https://developers.home-assistant.io/docs/api/rest/) to play 
...
[the short tutorial](articles/zotero_api.html) on how to create a Zotero API 
...
importing Norwegian books through ISBN. In the example below, Imsen (2020)
is imported using the Zotero magic wand (left) and *`c2z`* (right). Similarly, 
Zotero is unable to import Johannessen et al. (2021) using ISBN (cf. lookup 
failed). Evidently, Alma (47BIBSYS) is superior to Open WorldCat and similar
when it comes to identifying (most) Norwegian books.
...
defined collection, 5) exporting the items as BibLaTeX and creating a 
bibliography in HTML format using the APA7 reference style, and 6) cleaning up 
...
padding: 5px;">
`r paste0(example$bibliography, collapse = "")`
</div>
...
[here](https://github.com/oeysan/c2z/issues/), and feel to make a 
